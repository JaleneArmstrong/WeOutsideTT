export const TRINIDAD_TOBAGO_LOCATIONS = [
  // Trinidad
  {
    name: "Queens Park Savannah, Port of Spain",
    latitude: 10.6333,
    longitude: -61.5,
  },
  {
    name: "Maraval Beach, Port of Spain",
    latitude: 10.7458,
    longitude: -61.5583,
  },
  {
    name: "Chaguaramas Bay, Chaguaramas",
    latitude: 10.7333,
    longitude: -61.6333,
  },
  {
    name: "Asa Wright Nature Centre, Arima",
    latitude: 10.7667,
    longitude: -61.25,
  },
  ...
  {
    name: "Icacos Beach, Point-à-Pierre",
    latitude: 10.05,
    longitude: -61.4333,
  },
  { name: "San Fernando Waterfront", latitude: 10.2833, longitude: -61.45 },
  {
    name: "Port of Spain Market, Port of Spain",
    latitude: 10.6417,
    longitude: -61.5083,
  },
  ...
  // Tobago
  {
    name: "Pigeon Point Beach, Tobago",
    latitude: 11.1667,
    longitude: -60.8333,
  },
  ...
  {
    name: "Fort King George, Scarborough",
    latitude: 11.2167,
    longitude: -60.8,
  },
...
export function searchLocations(
  query: string,
): typeof TRINIDAD_TOBAGO_LOCATIONS {
  if (!query.trim()) return [];

  const lowerQuery = query.toLowerCase();
  return TRINIDAD_TOBAGO_LOCATIONS.filter((location) =>
